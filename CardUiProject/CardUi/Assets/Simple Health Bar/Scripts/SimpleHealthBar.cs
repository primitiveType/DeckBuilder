...
namespace Simple_Health_Bar.Scripts
{
    [ExecuteInEditMode]
    ...
    public class SimpleHealthBar : MonoBehaviour
    {
        ...
        void DisplayTextHandler()
        {
            ...
            switch (displayText)
            {
                ...
                {
                    barText.text = additionalText + (_currentValue).ToString("F0");
                }
                    break;
                case DisplayText.CurrentAndMaxValues:
                {
                    barText.text = additionalText + (_currentValue).ToString("F0") + " / " + _maxValue.ToString();
                }
                    break;
            }
        }
