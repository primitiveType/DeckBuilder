...
{
    public abstract class SummerJam1EventsBase : CardEvents
    {
        ...
        {
            EventHandle<UnitCreatedEventArgs> handler = new EventHandle<UnitCreatedEventArgs>(action, () => UnitCreated -= action);
        ...
        {
            EventHandle<IntentStartedEventArgs> handler = new EventHandle<IntentStartedEventArgs>(action, () => IntentStarted -= action);
        ...
        {
            EventHandle<UnitTransformedEventArgs> handler = new EventHandle<UnitTransformedEventArgs>(action, () => UnitTransformed -= action);
        ...
        {
            EventHandle<BattleEndedEventArgs> handler = new EventHandle<BattleEndedEventArgs>(action, () => BattleEnded -= action);
        ...
        {
            EventHandle<GameEndedEventArgs> handler = new EventHandle<GameEndedEventArgs>(action, () => GameEnded -= action);
        ...
        {
            EventHandle<GameStartedEventArgs> handler = new EventHandle<GameStartedEventArgs>(action, () => GameStarted -= action);
        ...
        {
            EventHandle<BattleStartedEventArgs> handler = new EventHandle<BattleStartedEventArgs>(action, () => BattleStarted -= action);
        ...
        {
            EventHandle<SomeTwitterEventEventArgs> handler = new EventHandle<SomeTwitterEventEventArgs>(action, () => SomeTwitterEvent -= action);
        ...
        {
            EventHandle<LeaveBattleEventArgs> handler = new EventHandle<LeaveBattleEventArgs>(action, () => LeaveBattle -= action);
        ...
        {
            EventHandle<CardMovedEventArgs> handler = new EventHandle<CardMovedEventArgs>(action, () => CardMoved -= action);
        ...
        {
            EventHandle<RequestRemoveCardEventArgs> handler = new EventHandle<RequestRemoveCardEventArgs>(action, () => RequestRemoveCard -= action);
        ...
        {
            EventHandle<AttackPhaseStartedEventArgs> handler =
                new EventHandle<AttackPhaseStartedEventArgs>(action, () => AttackPhaseStarted -= action);
        ...
        {
            EventHandle<AttackPhaseEndedEventArgs> handler = new EventHandle<AttackPhaseEndedEventArgs>(action, () => AttackPhaseEnded -= action);
        ...
        {
            EventHandle<DungeonPhaseStartedEventArgs> handler =
                new EventHandle<DungeonPhaseStartedEventArgs>(action, () => DungeonPhaseStarted -= action);
        ...
        {
            EventHandle<DungeonPhaseEndedEventArgs> handler = new EventHandle<DungeonPhaseEndedEventArgs>(action, () => DungeonPhaseEnded -= action);
        ...
        {
            EventHandle<MovementPhaseBeganEventArgs> handler =
                new EventHandle<MovementPhaseBeganEventArgs>(action, () => MovementPhaseBegan -= action);
        ...
        {
            EventHandle<RelicCreatedEventArgs> handler = new EventHandle<RelicCreatedEventArgs>(action, () => RelicCreated -= action);
        ...
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
                ...
                parameters[1].ParameterType != typeof(UnitCreatedEventArgs))
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, UnitCreatedEventArgs) args)");
            }
    ...
    public class OnIntentStartedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, IntentStartedEventArgs) args)");
            }
    ...
    public class IntentStartedEventArgs
    {
    ...
    public class OnUnitTransformedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, UnitTransformedEventArgs) args)");
            }
    ...
    public class UnitTransformedEventArgs
    {
    ...
    public class OnBattleEndedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, BattleEndedEventArgs) args)");
            }
    ...
    public class OnGameEndedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, GameEndedEventArgs) args)");
            }
    ...
    public class OnGameStartedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, GameStartedEventArgs) args)");
            }
    ...
    public class OnBattleStartedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, BattleStartedEventArgs) args)");
            }
    ...
    public class BattleStartedEventArgs
    {
    }
    ...
    public class OnSomeTwitterEventAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, SomeTwitterEventEventArgs) args)");
            }
    ...
    public class SomeTwitterEventEventArgs
    {
    }
    ...
    public class OnLeaveBattleAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, LeaveBattleEventArgs) args)");
            }
    ...
    public class LeaveBattleEventArgs
    {
    }
    ...
    public class OnCardMovedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardMovedEventArgs) args)");
            }
    ...
    public class OnRequestRemoveCardAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, RequestRemoveCardEventArgs) args)");
            }
    ...
    public class RequestRemoveCardEventArgs
    {
    }
    ...
    public class OnAttackPhaseStartedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, AttackPhaseStartedEventArgs) args)");
            }
    ...
    public class AttackPhaseStartedEventArgs
    {
    }
    ...
    public class OnAttackPhaseEndedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, AttackPhaseEndedEventArgs) args)");
            }
    ...
    public class AttackPhaseEndedEventArgs
    {
    }
    ...
    public class OnDungeonPhaseStartedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, DungeonPhaseStartedEventArgs) args)");
            }
    ...
    public class DungeonPhaseStartedEventArgs
    {
    }
    ...
    public class OnDungeonPhaseEndedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, DungeonPhaseEndedEventArgs) args)");
            }
    ...
    public class DungeonPhaseEndedEventArgs
    {
    }
    ...
    public class OnMovementPhaseBeganAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, MovementPhaseBeganEventArgs) args)");
            }
    ...
    public class MovementPhaseBeganEventArgs
    {
    }
    ...
    public class OnRelicCreatedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, RelicCreatedEventArgs) args)");
            }
    ...
    public class RelicCreatedEventArgs
    {
