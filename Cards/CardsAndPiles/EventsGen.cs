...
namespace CardsAndPiles
{
    public abstract class CardEventsBase : EventsBase
    {
        ...
        {
            EventHandle<RequestPlayCardEventArgs> handler = new EventHandle<RequestPlayCardEventArgs>(action, () => RequestPlayCard -= action);
        ...
        {
            EventHandle<CardPlayedEventArgs> handler = new EventHandle<CardPlayedEventArgs>(action, () => CardPlayed -= action);
        ...
        {
            EventHandle<CardCreatedEventArgs> handler = new EventHandle<CardCreatedEventArgs>(action, () => CardCreated -= action);
        ...
        {
            EventHandle<CardDiscardedEventArgs> handler = new EventHandle<CardDiscardedEventArgs>(action, () => CardDiscarded -= action);
        ...
        {
            EventHandle<CardExhaustedEventArgs> handler = new EventHandle<CardExhaustedEventArgs>(action, () => CardExhausted -= action);
        ...
        public EventHandle<RequestDamageMultipliersEventArgs> SubscribeToRequestDamageMultipliers(
            EventHandleDelegate<RequestDamageMultipliersEventArgs> action)
        {
            EventHandle<RequestDamageMultipliersEventArgs> handler =
                new EventHandle<RequestDamageMultipliersEventArgs>(action, () => RequestDamageMultipliers -= action);
        ...
        public EventHandle<RequestDamageModifiersEventArgs> SubscribeToRequestDamageModifiers(
            EventHandleDelegate<RequestDamageModifiersEventArgs> action)
        {
            EventHandle<RequestDamageModifiersEventArgs> handler =
                new EventHandle<RequestDamageModifiersEventArgs>(action, () => RequestDamageModifiers -= action);
        ...
        {
            EventHandle<CardPlayFailedEventArgs> handler = new EventHandle<CardPlayFailedEventArgs>(action, () => CardPlayFailed -= action);
        ...
        {
            EventHandle<RequestHealEventArgs> handler = new EventHandle<RequestHealEventArgs>(action, () => RequestHeal -= action);
        ...
        {
            EventHandle<ChooseCardsToDiscardEventArgs> handler =
                new EventHandle<ChooseCardsToDiscardEventArgs>(action, () => ChooseCardsToDiscard -= action);
        ...
        {
            EventHandle<EntityKilledEventArgs> handler = new EventHandle<EntityKilledEventArgs>(action, () => EntityKilled -= action);
        ...
        {
            EventHandle<DamageDealtEventArgs> handler = new EventHandle<DamageDealtEventArgs>(action, () => DamageDealt -= action);
        ...
        {
            EventHandle<HealDealtEventArgs> handler = new EventHandle<HealDealtEventArgs>(action, () => HealDealt -= action);
        ...
        {
            EventHandle<TurnEndedEventArgs> handler = new EventHandle<TurnEndedEventArgs>(action, () => TurnEnded -= action);
        ...
        {
            EventHandle<TurnBeganEventArgs> handler = new EventHandle<TurnBeganEventArgs>(action, () => TurnBegan -= action);
        ...
        {
            EventHandle<DrawPhaseBeganEventArgs> handler = new EventHandle<DrawPhaseBeganEventArgs>(action, () => DrawPhaseBegan -= action);
        ...
        {
            EventHandle<CardDrawnEventArgs> handler = new EventHandle<CardDrawnEventArgs>(action, () => CardDrawn -= action);
    ...
    public class OnRequestPlayCardAttribute : EventsBaseAttribute
    {
        ...
        {
            ParameterInfo[] parameters = attached.GetParameters();
                ...
                parameters[1].ParameterType != typeof(RequestPlayCardEventArgs))
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, RequestPlayCardEventArgs) args)");
            }
    ...
    public class RequestPlayCardEventArgs
    {
        public RequestPlayCardEventArgs(IEntity CardId, IEntity Target)
        {
            this.CardId = CardId;
            this.Target = Target;
        }

        public IEntity CardId { get; }
    ...
    public class OnCardPlayedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardPlayedEventArgs) args)");
            }
    ...
    public class OnCardCreatedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardCreatedEventArgs) args)");
            }
    ...
    public class OnCardDiscardedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardDiscardedEventArgs) args)");
            }
    ...
    public class OnCardExhaustedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardExhaustedEventArgs) args)");
            }
    ...
    public class CardExhaustedEventArgs
    {
    ...
    public class OnRequestDamageMultipliersAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, RequestDamageMultipliersEventArgs) args)");
            }
    ...
    public class RequestDamageMultipliersEventArgs
    {
        public RequestDamageMultipliersEventArgs(int Amount, IEntity Source, IEntity Target)
        {
            this.Amount = Amount;
            this.Source = Source;
            this.Target = Target;
    ...
    public class OnRequestDamageModifiersAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, RequestDamageModifiersEventArgs) args)");
            }
    ...
    public class RequestDamageModifiersEventArgs
    {
        public RequestDamageModifiersEventArgs(int Amount, IEntity Source, IEntity Target)
        {
            this.Amount = Amount;
            this.Source = Source;
            this.Target = Target;
    ...
    public class OnCardPlayFailedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardPlayFailedEventArgs) args)");
            }
    ...
    public class CardPlayFailedEventArgs
    {
    ...
    public class OnRequestHealAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, RequestHealEventArgs) args)");
            }
    ...
    public class RequestHealEventArgs
    {
        public RequestHealEventArgs(int Amount, IEntity Source, IEntity Target)
        {
            this.Amount = Amount;
            this.Source = Source;
            this.Target = Target;
    ...
    public class OnChooseCardsToDiscardAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, ChooseCardsToDiscardEventArgs) args)");
            }
    ...
    public class ChooseCardsToDiscardEventArgs
    {
    ...
    public class OnEntityKilledAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, EntityKilledEventArgs) args)");
            }
    ...
    public class EntityKilledEventArgs
    {
    ...
    public class OnDamageDealtAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, DamageDealtEventArgs) args)");
            }
    ...
    public class OnHealDealtAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, HealDealtEventArgs) args)");
            }
    ...
    public class HealDealtEventArgs
    {
    ...
    public class OnTurnEndedAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, TurnEndedEventArgs) args)");
            }
    ...
    public class OnTurnBeganAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, TurnBeganEventArgs) args)");
            }
    ...
    public class OnDrawPhaseBeganAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, DrawPhaseBeganEventArgs) args)");
            }
    ...
    public class DrawPhaseBeganEventArgs
    {
    }
    ...
    public class OnCardDrawnAttribute : EventsBaseAttribute
    {
        public override IDisposable GetEventHandle(MethodInfo attached, IComponent instance, EventsBase events)
        {
            ...
            {
                throw new NotSupportedException(
                    "Wrong parameters for attribute usage! must match signature (object sender, CardDrawnEventArgs) args)");
            }
