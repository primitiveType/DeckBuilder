...
namespace Wunderwunsch.HexMapLibrary
{
    ...
    public static class HexUtility
    {
        ...
        public static EdgeAlignment GetEdgeAlignment(Vector3Int edge)
        {
            ...
            return EdgeAlignment.ParallelToCubeZ;
        }
        ...
        public static CornerType GetCornerType(Vector3Int corner)
        {
            ...
            return CornerType.BottomOfYParallelEdge;
        }
        ...
        /// <summary>
        ///     Helper Method for GetValidCoordinates which just compares input Coordinates with the set of valid coordinates of
        ///     the map and removes all invalid.
        /// </summary>
