...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    {
        /// <summary>
        ///     constructor without passing an instance of E in , creating a default instance of E by calling it's parameterless
        ///     constructor
        /// </summary>
        public Corner(Vector3Int position, int index, Vector2 normalizedPosition, bool createDefaultDataObject = true) : base(position, index,
            normalizedPosition)
        {
