...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    {
        private readonly TilePositionProvider tilePositionProvider;
        ...
        /// <summary>
        ///     rotates the input tile coordinate 60° Clockwise around the specified center point and returns the tile on that
        ///     position. returns null if outside of map bounds
        /// </summary>
        ...
        /// <summary>
        ///     rotates the input tile coordinate 60° Counter-clockwise around the specified center point and returns the tile on
        ///     that position. returns null if outside of map bounds
        /// </summary>
