...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    public class EdgesDataProvider<E> where E : new()
    {
        ...
        private readonly EdgePositionsProvider edgesPositionsProvider;
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.AdjacentEdges(edge);
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.AdjacentEdges(edge.Position);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.AdjacentToCorner(corner);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.AdjacentToCorner(corner.Position);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.OfTile(tile);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.OfTile(tile.Position);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.WithinDistanceOfEdge(centerEdge, maxDistance, includeSelf);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.WithinDistanceOfEdge(centerEdge.Position, maxDistance, includeSelf);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.WithinDistanceOfCorner(centerCorner, maxDistance);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.WithinDistanceOfCorner(centerCorner.Position, maxDistance);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.AtExactDistance(centerEdge, distance);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        public List<Edge<E>> PathBetweenCorners(Vector3Int originCorner, Vector3Int targetCorner,
            float horizontalNudgeFromOriginCenter = NudgePositive)
        {
            List<Vector3Int> edgePositions = edgesPositionsProvider.PathBetweenCorners(originCorner, targetCorner, horizontalNudgeFromOriginCenter);
            return GetEdgesFromCoordinates(edgePositions);
        }
        ...
        {
            List<Vector3Int> edges = edgesPositionsProvider.TileBorders(tiles);
