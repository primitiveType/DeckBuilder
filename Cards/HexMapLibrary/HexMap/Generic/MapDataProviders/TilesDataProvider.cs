...
{
    public class TilesDataProvider
    {
        private readonly Dictionary<Vector3Int, Tile> tilesByPosition;
        private readonly TilePositionsProvider tilesPositionsProvider;

        public TilesDataProvider(Dictionary<Vector3Int, Tile> tilesByPosition, TilePositionsProvider tilesPositionsProvider)
        {
        ...
        public List<Tile> AdjacentToTile(Tile tile)
        {
        ...
        ///     returns the map tiles adjacent to the input tile
        /// </summary>
        public List<Tile> AdjacentToTile(Vector3Int tilePosition)
        {
        ...
        public List<Tile> AdjacentToEdge(Vector3Int edge)
        {
        ...
        ///     returns the map tiles adjacent to the input edge
        /// </summary>
        public List<Tile> AdjacentToEdge(Edge edge)
        {
        ...
        public List<Tile> AdjacentToCorner(Vector3Int corner)
        {
        ...
        ///     returns the map tiles adjacent to the input corner
        /// </summary>
        public List<Tile> AdjacentToCorner(Corner corner)
        {
        ...
        public List<Tile> Cone(Tile origin, Vector3Int targetDirection, float coneHalfAngle, int coneLength)
        {
        ...
        ///     returns all map tiles of a cone starting at a point with given direction, length and width
        /// </summary>
        public List<Tile> Cone(Vector3Int origin, Vector3Int targetDirection, float coneHalfAngle, int coneLength)
        {
        ...
        public List<Tile> Line(Tile origin, Vector3Int target, bool includeOrigin, float horizontalNudgeFromOriginCenter = NudgePositive)
        {
        ...
        ///     returns tiles forming a line between origin and target tile, optionally including the origin tile itself
        /// </summary>
        public List<Tile> Line(Vector3Int origin, Vector3Int target, bool includeOrigin, float horizontalNudgeFromOriginCenter = NudgePositive)
        {
        ...
        public List<Tile> Ring(Tile center, int radius, int thicknessInwards)
        {
        ...
        ///     returns all map tiles of a ring around center in no defined order
        /// </summary>
        public List<Tile> Ring(Vector3Int center, int radius, int thicknessInwards)
        {
        ...
        /// </summary>
        public List<Tile> Ring(Tile center, int radius, TileDirection startDirection, bool clockwise)
        {
        ...
        ///     returns all map tiles of a ring around center in order specified by parameters (startDirection, clockwise)
        /// </summary>
        public List<Tile> Ring(Vector3Int center, int radius, TileDirection startDirection, bool clockwise)
        {
        ...
        public List<Tile> Disc(Tile center, int range, bool includeCenter)
        {
        ...
        ///     Returns all tiles of the map which are within distance of the center point, either with or without the center point
        /// </summary>
        public List<Tile> Disc(Vector3Int center, int range, bool includeCenter)
        {
        ...
        public List<List<Tile>> ContiguousAreasOfInputTiles(ICollection<Tile> inputTiles)
        {
            ...
            List<List<Vector3Int>> areasPositions = tilesPositionsProvider.ContiguousAreasOfInputTiles(tiles);
            foreach (List<Vector3Int> area in areasPositions)
            {
        ...
        /// </summary>
        /// ![left = input tile list , right = output separated into different areas](Map_GetTiles_ContiguousCombined.png)
        public List<List<Tile>> ContiguousAreasOfInputTiles(ICollection<Vector3Int> inputTiles)
        {
            List<List<Tile>> areas = new List<List<Tile>>();
            List<List<Vector3Int>> areasPositions = tilesPositionsProvider.ContiguousAreasOfInputTiles(inputTiles);
            foreach (List<Vector3Int> area in areasPositions)
            {
                areas.Add(GetTilesFromCoordinates(area));
            }
        ...
        /// </summary>
        private List<Tile> GetTilesFromCoordinates(ICollection<Vector3Int> coordinates)
        {
