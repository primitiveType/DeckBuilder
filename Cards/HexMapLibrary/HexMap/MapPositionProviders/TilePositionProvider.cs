...
namespace Wunderwunsch.HexMapLibrary
{
    public class TilePositionProvider
    {
        ...
        /// <summary>
        ///     returns the periodic tile coordinate of the input cartesian coordinate, the out parameter specifies if that
        ...
        /// <summary>
        ///     returns the periodic tile coordinate of the input tile coordinate rotated 60° Clockwise around the specified center
        ///     tile
        /// </summary>
        public Vector3Int FromTileRotated60DegreeClockwise(Vector3Int center, Vector3Int pointToRotate)
        {
            ...
            if (coordinateWrapper != null)
            {
                rotated = coordinateWrapper.WrapTileCoordinate(rotated);
            }
        ...
        /// <summary>
        ///     returns the periodic tile coordinate of the input tile coordinate rotated 60° Clockwise around the specified center
        ///     tile, the out parameter specifies if that coordinate belongs to the map
        /// </summary>
        public Vector3Int FromTileRotated60DegreeClockwise(Vector3Int center, Vector3Int pointToRotate, out bool tileIsOnMap)
        {
            ...
            tileIsOnMap = false;
            if (tileIndexByPosition.ContainsKey(rotated))
            {
                tileIsOnMap = true;
            }
        ...
        /// <summary>
        ///     returns the periodic tile coordinate of the input tile coordinate rotated 60° Counter-clockwise around the
        ///     specified center tile
        /// </summary>
        ...
        /// <summary>
        ///     returns the periodic tile coordinate of the input tile coordinate rotated 60° Counter-clockwise around the
        ///     specified center tile, the out parameter specifies if that coordinate belongs to the map
        /// </summary>
        ...
        public bool IsInputCoordinateOnMap(Vector3Int inputTileCoordinate)
        {
            if (coordinateWrapper != null)
            {
                inputTileCoordinate = coordinateWrapper.WrapTileCoordinate(inputTileCoordinate);
            }

            if (tileIndexByPosition.ContainsKey(inputTileCoordinate))
            {
                return true;
            }
