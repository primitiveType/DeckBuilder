...
namespace Wunderwunsch.HexMapLibrary
{
    public class CoordinateWrapperRectangularHorizontalPeriodic : CoordinateWrapper
    {
        ...
        public override Vector3 WrapCartesianCoordinate(Vector3 position)
        {
            Vector2Int
                offsetPosition =
                    HexConverter.CartesianCoordToOffsetCoord(
                        position); //We need to use the upperBound parameter instead of using the mapsize Property because for edges we need mapsize.y*2
        ...
        /// <summary>
        ///     Returns the closest periodic coordinate of the input tile coordinate - Assumes coordinates are not further than 1
        ///     map size away from actual map
        public override Vector3Int WrapTileCoordinate(Vector3Int position)
        {
            Vector2Int
                offsetPosition =
                    HexConverter.TileCoordToOffsetTileCoord(
                        position); //We need to use the upperBound parameter instead of using the mapsize Property because for edges we need mapsize.y*2
        ...
        /// <summary>
        ///     Returns the closest periodic coordinates of a collection of tile coordinates. Assumes coordinates are not further
        ///     than 1 map size away from actual map
        /// </summary>
        ...
        /// <summary>
        ///     This returns the closest "virtual" position of target tile position on a wrapping map, intended to be used in
        ...
        /// <summary>
        ///     returns the closest periodic edge position of the input edge position - Assumes coordinates are not further than 1
        ///     map size away from actual map
        /// </summary>
        ...
        /// <summary>
        ///     Returns the closest periodic coordinates of a collection of edge coordinates. Assumes coordinates are not further
        ///     than 1 map size away from actual map
        /// </summary>
        ...
        /// <summary>
        ///     returns the closest periodic corner position of the input corner position - Assumes coordinates are not further
        ///     than 1 map size away from actual map
        /// </summary>
        ...
        /// <summary>
        ///     Returns the closest periodic coordinates of a collection of corner coordinates. Assumes coordinates are not further
        ///     than 1 map size away from actual map
        /// </summary>
