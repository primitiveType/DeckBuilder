    ...
    public static partial class HexGrid
    {
        public static class GetCorner
        {
            ...
            public static Vector3Int BetweenNeighbouringTileCoordinates(Vector3Int a, Vector3Int b, Vector3Int c)
            {
                ...
                {
                    throw new ArgumentException("Tiles a and b don't have a distance of 1, therefore and not neighbours and share no Edge");
                }

                if (GetDistance.BetweenTiles(a, c) != 1)
                {
                    throw new ArgumentException("Tiles a and c don't have a distance of 1, therefore and not neighbours and share no Edge");
                }

                if (GetDistance.BetweenTiles(b, c) != 1)
                {
                    throw new ArgumentException("Tiles b and c don't have a distance of 1, therefore and not neighbours and share no Edge");
                }
