...
{
    /// <summary>
    ///     Contains many helper methods facilitating working with a hexagonal coordinate system. Assumes the grid being on the
    ///     (infinite) XZ-Plane.
    ...
    public static partial class HexGrid
    {
        ...
        internal static Vector3Int[] TileDirectionVectors =
        {
        ...
        internal static Vector3Int[] ClockWiseNeighbourOfEdgeByEdgeDirection =
        {
        ...
        //Array Index is aligned with HexEnums.EdgeDirection value
        internal static Vector3Int[] CounterClockWiseNeighbourOfEdgeByEdgeDirection =
        {
