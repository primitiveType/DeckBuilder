...
namespace Wunderwunsch.HexMapLibrary
{
    ...
    public static class HexConverter
    {
        ...
        public static Vector3 OffsetTileCoordToCartesianCoord(Vector2Int offsetTileCoord)
        {
            ...
            if (offsetTileCoord.y % 2 == 0)
            {
                offsetXAdjustment = 0;
            }
            else
            {
                offsetXAdjustment = 0.5f * sqrt3;
            }
        ...
        {
            Vector3 worldPos = TileCoordToCartesianCoord(edgeCoord);
        ...
        public static Vector3Int CartesianCoordToClosestEdgeCoord(Vector3 cartesianCoord)
        {
            ...
            {
                Vector3 worldPos = TileCoordToCartesianCoord(edgeCoords[i]);
        ...
        public static Vector3Int CartesianCoordToClosestCornerCoord(Vector3 cartesianCoord)
        {
            ...
            {
                Vector3 worldPos = TileCoordToCartesianCoord(cornerCoords[i]);
        ...
        {
            Vector3 worldPos = TileCoordToCartesianCoord(cornerCoord);
        ...
        {
            Vector3 cartesianCoord = TileCoordToCartesianCoord(tileCoordinate);
        ...
        {
            Vector3 cartesianCoord = EdgeCoordToCartesianCoord(edgeCoordinate);
            return CartesianCoordToNormalizedPosition(cartesianCoord, minX, maxX, minZ, maxZ);
        }
        ...
        {
            Vector3 cartesianCoord = CornerCoordToCartesianCoord(cornerCoordinate);
            return CartesianCoordToNormalizedPosition(cartesianCoord, minX, maxX, minZ, maxZ);
        }
